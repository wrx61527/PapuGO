    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if action == 'login':
                ...
                if user_row and user_row['Password'] == password: # Obecna, NIEBEZPIECZNA wersja
                ...
                if not current_restaurant_id: flash('Wybierz restaurację.', 'warning')
                 ...
                 if not dish_id_str or not current_restaurant_id: flash('Brak ID dania/restauracji.', 'warning')
                      ...
                      try:
                          ...
                          if deleted_count > 0: app.logger.info(f"Usunięto danie ID: {dish_id}"); flash(f'Danie ID: {dish_id} usunięte.', 'success');
